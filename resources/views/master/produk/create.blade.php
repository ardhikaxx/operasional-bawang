...
<div class="d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4 class="fw-bold mb-1"><i class="fas fa-plus-circle me-2 text-primary"></i>Tambah Produk Baru</h4>
...
<div class="card max-w-lg">
    <div class="card-header">Formulir Input Produk</div>
        ...
        <form action="{{ route('master.produk.store') }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="kode_produk" class="form-control font-monospace @error('kode_produk') is-invalid @enderror" value="{{ old('kode_produk') }}" placeholder="cth: PRD-001" required>
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" name="nama_produk" class="form-control @error('nama_produk') is-invalid @enderror" value="{{ old('nama_produk') }}" placeholder="cth: Bawang Merah Super" required>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control input-nominal @error('harga_estimasi') is-invalid @enderror" data-target="harga_estimasi_val" value="{{ old('harga_estimasi') ? number_format(old('harga_estimasi'),0,',','.') : '' }}" placeholder="0" required>
                    <input type="hidden" name="harga_estimasi" id="harga_estimasi_val" value="{{ old('harga_estimasi', 0) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="stok_minimum" class="form-control @error('stok_minimum') is-invalid @enderror" value="{{ old('stok_minimum', 10) }}" min="0" required>
